...
function Card({
  ...
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-card text-card-foreground flex flex-col gap-6 rounded-[32px] border border-border/80 py-8 shadow-[0_24px_48px_-32px_rgba(25,25,32,0.35)] transition-all duration-200",
        className
      )}
      {...props} />
  );
...
function CardTitle({
  ...
  return (
    <div
      ...
      className={cn("leading-tight font-serif text-2xl font-semibold tracking-tight", className)}
      {...props} />
  );
}
